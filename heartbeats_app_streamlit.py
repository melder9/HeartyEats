...
EDAMAM_ACCOUNT_USER = st.secrets["EDAMAM_ACCOUNT_USER"]
...
def generate_plating_image(recipe_name):
    enhanced_prompt = f"Elevated home-style food photography of {recipe_name}, full plated meal entirely visible, the whole plate in frame, centered, clean overhead or slightly angled view, modern plain white dish, healthy heart meal, cinematic lighting."
    try:
